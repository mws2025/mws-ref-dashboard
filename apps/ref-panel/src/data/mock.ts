...
export const MAPPOOL: PoolMap[] = [
  ...
  { slot: "PS1", pool: "PS", map: "Riya - IMPULSE [Inner Oni] (Quorum)",                                      bpm: 145, ar: 5,  cs: 5, status: "completed", pickedBy: "Strawberry_Jam",  winner: "Strawberry_Jam"    },
  { slot: "PS2", pool: "PS", map: "Xyris - Terrablazer [Laevatain] (Alwaysyukaz)",                            bpm: 260, ar: 0,  cs: 2, status: "banned",    bannedBy: "Strawberry_Jam"               },
...
export const AUDIT_LOG = [
  ...
  { time: "10:19", actor: "System", msg: "Strawberry Jam banned PS2." },
  { time: "10:22", actor: "System", msg: "Blueberries banned HR2." },
  { time: "10:25", actor: "System", msg: "Strawberry Jam picked PS1." },
  { time: "10:37", actor: "System", msg: "PS1 done. Winner: Strawberry Jam. +1 Sugar." },
