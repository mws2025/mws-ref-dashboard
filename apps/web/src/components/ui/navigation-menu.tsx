...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "focus-visible:ring-ring/50 flex items-center gap-2 rounded-lg p-2 text-base transition-all outline-none hover:opacity-50 focus-visible:ring-3 focus-visible:outline-1 in-data-[slot=navigation-menu-content]:rounded-md [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
